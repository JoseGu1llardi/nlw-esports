            ...
            <Dialog.Content className="fixed bg-[#2A2634] py-8 px-10 text-white top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 rounded-lg w-[480px] shadow-lg shadow-black/25">
                ...
                <form onSubmit={handleCreateAd} action="" className='mt-8 flex flex-col gap-4'>
                    ...
                    <div className=" flex flex-col gap-2">
                        ...
                        <Input id="name" name='name' placeholder="What do they call you in the game?" />
                    </div>

                    <div className='grid grid-cols-2 gap-6'>
                        <div className="flex flex-col gap-2">
                            <label htmlFor="yearsPlaying">How many years have you played?</label>
                            <Input id='yearsPlaying' name='yearsPlaying' type="text" placeholder="It's ok to be ZERO" />
                        </div>
                    ...
                    <div className="flex gap-6">
                        ...
                        <div className="flex flex-col gap-2 flex-1">
                            ...
                            <div className='grid grid-cols-2 gap-2'>
                                ...
                                <Input id='hourEnd' name='hourEnd' type="time" placeholder='At' />
                            </div>
                        </div>
                    </div>
